<div class="flex flex-col w-[300px] mx-auto py-16">
    ...
    <div class="flex gap-4 justify-between">
        ...
        <button wire:click='addTodo'
            class="py-2 px-4 bg-indigo-500 disabled:cursor-not-allowed disabled:bg-opacity-90 hover:bg-indigo-600 rounded text-white">addTodo</button>
    ...
    <div class="py-6">
        ...
        <div class="flex gap-4 py-1 justify-between item-center">
